	...
	public static void main(String[] args) {
		...
		for (String fileName : filenameList) {
			...
			try {
				...
				ArrayList<String> firstInningsBatmans = BowlersUtil
						.getBowlers(match.getFirstInnings());

				/***** get batmans in secondInnings ***************************/
				ArrayList<String> SecondInningsBatmans = BowlersUtil
...
//
//					for (int i = 0; i < firstInningsBatmans.size(); i++) {
//
//						newBatsman = new Batsman();
//
//						batsmansName = firstInningsBowlers.get(i);
//
